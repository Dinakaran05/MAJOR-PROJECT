...
@WebServlet("/Trustuserformsrequest")
public class Trustuserformsrequest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Trustuserformsrequest() {
        super();
	...
	MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"NS02-Orphanage\\WebContent\\childdoc\\";
		...
		int reg=0;
			...
			try {
				con=dbcon.create();
					...
					PreparedStatement ps=con.prepareStatement("INSERT INTO child_trust.fundform VALUES(id,?,?,?,?,?,?,?,?)");
					...
					ps.setString(5, paramValues.get(6).toString());
					
					
					ps.setString(6, paramValues.get(8).toString());
				
					ps.setString(7 ,"request");
				
					ps.setString(8 , paramValues.get(10).toString());
					
					
					ps.executeUpdate();

					
					response.sendRedirect("FundLogin.jsp");
